...
Sequelize_i18n.prototype.setInstanceMethods = function(model) {
    model.prototype.get_i18n = this.get_i18n(Sequelize_i18n.prototype.getI18nName(model.name));
    model.prototype.set_i18n = this.set_i18n(Sequelize_i18n.prototype.getI18nName(model.name));
};
...
Sequelize_i18n.prototype.afterDestroy = hooks.afterDestroy;
